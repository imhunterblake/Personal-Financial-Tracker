...
![Transaction List](./screenshots/history.png)
![Recent List](./screenshots/recent.png)

### Add Transaction 
![Add Category](./screenshots/dropdown-category.png)
![Add Date](./screenshots/date-select.png)
